...
<div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Notice  Archives By Month</h1>
                </div><!-- /.col -->
                <!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
<div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-info">
                ...
                <div class="card-header">
                    ...
                    <h3 class="card-title">Notice  Archives By Month </h3>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#notice_arc_form").submit(function(event) {
     ...
     var baseurl = '<?php echo $this->route->site_url("Admin/ajaxresponseforNoticearchievesByMonth"); ?>';


                var formData = {
                    notice_year: $("#notice_year option:selected").text(),
                    notice_month: $("#notice_month option:selected").val(),
                };
