    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <table id="adminCategory" class="table table-bordered table-hover display">
                        <thead>
                            <tr>
                                           ...
                                           <?php
												...
												if($is_superadmin==1){?>
													...
													if (@$_GET['status'] == 0 && $categorylist->status != 1){
                                                        ...
                                                        echo '<i class="fa fa-eye category-unpublish-button" style="color:red;cursor:pointer" title="Unpublished"></i>';
                                                    }
