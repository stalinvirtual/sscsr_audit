...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet"
        href="<?php echo htmlentities($this->theme_url); ?>/plugins/fontawesome-free/css/all.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="<?php echo htmlentities($this->theme_url); ?>/dist/css/ionicons.min.css">
    <!-- Tempusdominus Bootstrap 4 -->
    <link rel="stylesheet"
        href="<?php echo htmlentities($this->theme_url); ?>/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
    <link rel="stylesheet"
        href="<?php echo htmlentities($this->theme_url); ?>/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- JQVMap -->
    ...
    <!-- overlayScrollbars -->
    <link rel="stylesheet"
        href="<?php echo htmlentities($this->theme_url); ?>/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet"
        href="<?php echo htmlentities($this->theme_url); ?>/plugins/daterangepicker/daterangepicker.css">
    <!-- summernote -->
    <link rel="stylesheet"
        href="<?php echo htmlentities($this->theme_url); ?>/plugins/summernote/summernote-bs4.min.css">
    <!-- DataTables -->
    <link rel="stylesheet"
        href="<?php echo htmlentities($this->theme_url); ?>/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet"
        href="<?php echo htmlentities($this->theme_url); ?>/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
    <link rel="stylesheet"
        href="<?php echo htmlentities($this->theme_url); ?>/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="<?php echo htmlentities($this->theme_url); ?>/dist/img/AdminLTELogo.png"
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" rel="noopener noreferrer" target="_blank" href="#"><i class="fa fa-globe"
    ...
    top: 9px;
    left: -24%;"><span class="material-icons" id="so" style="color: #a94442;font-size:14px;font-weight: bold; ">
                        </span>
                    </div>
                </li>
                <li class="nav-item dropdown user user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo htmlentities($this->theme_url); ?>/dist/img/admin.png"
                            class="user-image img-circle elevation-2 alt=" User Image">
                        <span class="hidden-xs">
                            <?php echo $logged_user['username']; ?>
                        </span>
                        <span class="hidden-xs">(
                            <?php echo $logged_user['rolename']; ?>)
                        </span>
                    </a>
                        ...
                        <li class="user-footer">
                            <div class="row">
                                ...
                                <div class="col-6 text-center">
                                    <a href="<?php echo $this->route->site_url("Admin/logout"); ?>"
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo $list_of_phase_master;
                                    ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Phase</p>
                                    </a>
