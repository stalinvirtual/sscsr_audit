			...
			<div class="row breadcrumbruler">
				<div class="col-lg-12">
					<ul class="breadcrumb" style="margin-left:35px;">
						...
						<li><a href="#" class="bread">Tender </a><i class="icon-angle-right"></i></li>
					</ul>
				</div>
			</div>
		</div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                     ...
                     <td><?= date("d-m-Y", strtotime($tender->effect_from_date)); ?></td>
					 ...
					 <?php  $uploadPath = 'tender' . '/' . $tender->attachment;
                            ...
                            <u><a class="pdfanchorclass" href="<?= $file_location ?>" rel = "noopener noreferrer" target="_blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> <?= $tender->pdf_name ?></a><br>(<?= filesize_formatted($uploadPath)?>)</u>
					  </td>
