							...
							<form class="form-horizontal" action="#" method="post" id="upload_exam_details">
								...
								<div class="form-group">
									<label for="exam_year" class="col-sm-2 control-label">Select Year<font style="color:red"
											;>*</font> </label>
									<div class="col-sm-6">
										<input type="text" min="<?php echo date('Y') - 5; ?>" max="<?php echo date('Y') + 5; ?>"
											step="1" name="exam_year" id="exam_year" maxlength="4"
								...
								<div class="form-group selectedtier">
									<label for="selectedtier" class="col-sm-2 control-label">No of days prior to download
										<font style="color:red" ;>*</font> </label>
									<div class="col-sm-6">
										<input type="text" name="no_of_days" id="no_of_days" maxlength="2" size="1"
											type="number" value="" />
									</div>
								</div>
								...
								<div class="form-group excel_file_attachment">
									<label for="excelfile" class="col-sm-2 control-label">Select(.xlsx) File<font
											style="color:red" ;>*</font> </label>
								...
								<div id="overlay" style="display:none;">
									...
									<div class="progress" style="height:20px">
										<div id="processing-bar" class="progress-bar" role="progressbar" style="width: 0%;"
											aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
									</div>
									<br>
									<h3 style="color:black;text-align:center">Please wait</h3>
									<button class="btn btn-success" style="color:white;display:none" id="ajax-button"
										type="button">Stop Process</button>
									<br>
									<div class="donot_refresh_div">
										<h5 style="color:white;text-align:center"><i class="fa fa-ban icon-red"
												aria-hidden="true"></i>&nbsp;&nbsp;Donot Refresh the page</h5>
									</div>
								</div>
								<!-- Spinner div End-->
							</form>
