					...
					<div class="form-title">
						<div class="row">
							<div class="col-lg-9 form-group">
								<h4>Candidate Details By Exam</h4>
							</div>

							<div class="col-lg-2 form-group">
								<a class="btn w3ls-button hvr-icon-float-away col-24" href="upload_candidate_details.php">
									Upload</a>
							</div>
						</div>
					</div>
						...
						<div data-example-id="simple-form-inline">
							<form class="form-horizontal">
								<div class="form-group">
									<label for="examname" class="col-sm-4 control-label">Exam Name<font style="color:red" ;>
											*</font> </label>
									<div class="col-sm-6">
								...
								<div class="form-group">
									<label for="examyear" class="col-sm-4 control-label">Exam Month / Year<font
											style="color:red" ;>*</font> </label>
									<div class="col-sm-6">
										<input type="month" id="exam_year" name="exam_year" class="form-control"
											placeholder="Enter Exam Year" value="">
									</div>
								</div>
								<button type="button" class="btn w3ls-button hvr-icon-spin col-5" id="searchdata"> Load
								</button>
							</form>
						</div>
					</div>
